...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        home: Scaffold(
          appBar: AppBar(backgroundColor: Color.fromARGB(255, 220, 0, 0),)
        )
    );
  }
}
...
class RandomJokes extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final _biggerFont = TextStyle(fontSize: 20.0, fontStyle: FontStyle.italic);
...
class MainPage extends State<StateMainPage>{
  ...
  Widget build(BuildContext context){
    ...
    return Form(key: formKey,
        child:Scaffold(
            appBar: AppBar(title: Text("Chuck Norris API"),backgroundColor: Color.fromARGB(255, 220, 0, 0),),
